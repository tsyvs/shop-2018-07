...
gulp.task('tinypng', function () {
  return gulp.src(img_optimizing)
    .pipe(tinypng('__TINYPNG_API_KEY__'))
    .pipe(gulp.dest(path.img_dest));
});

gulp.task('del', function () {
  return del(img_optimizing, { force: true })
    .then(paths => {
